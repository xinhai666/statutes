...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="articlecolumn" class="select">
					<option value="0">dadada</option>
					<option value="1">bbbb</option>
					<option value="11">cccc</option>
					<option value="12">aaaa</option>
					<option value="13">ddddd</option>
				</select>
				</span> </div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span>*</span>条款内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="removeIframe();" class="btn btn-default radius" type="button">&nbsp;&nbsp;保存&nbsp;&nbsp;</button>
				<button onClick="removeIframe();" class="btn btn-default radius" type="button">&nbsp;&nbsp;复制条款&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</article>
